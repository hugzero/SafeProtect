...
import com.vince.safeprotect.db.dao.AntiVirusDao;
import com.vince.safeprotect.util.Md5Encoder;
...
public class AntiVirusActivity extends Activity {
	...
	// 显示发现的病毒数目
	private TextView tv_scan_status2;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		tv_scan_status2 = (TextView) findViewById(R.id.tv_scan_status2);
