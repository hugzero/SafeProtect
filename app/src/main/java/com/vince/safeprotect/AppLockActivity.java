...
import com.vince.safeprotect.domain.AppInfo;
import com.vince.safeprotect.engine.AppInfoProvider;
		...
		lv_applock.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				if(lockedPacknames.contains(packname)){//锁定状态
					//dao.delete(packname);
					//采用内容提供者来观察数据库中的数据变化
					Uri uri = Uri.parse("content://com.vince.applock/DELETE");
					...
					//dao.add(packname);
					Uri uri = Uri.parse("content://com.vince.applock/ADD");
