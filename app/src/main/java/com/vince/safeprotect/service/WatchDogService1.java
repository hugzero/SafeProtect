...
import com.vince.safeprotect.EnterPwdActivity;
import com.vince.safeprotect.IService;
import com.vince.safeprotect.db.dao.AppLockDao;
...
public class WatchDogService1 extends Service {
	...
	public void onCreate() {
		//设置要匹配的Uri路径
		Uri uri = Uri.parse("content://com.vince.applock/");
		observer = new MyObserver(new Handler());
		//第二个参数如果为true，Uri中的content://com.vince.applock/匹配正确即可感应到，后面的（ADD或DELETE）不用继续在匹配下去
